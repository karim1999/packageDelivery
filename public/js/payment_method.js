...
// Adapted from convert-source-map (MIT)
        ...
        !function (t, e) {
            ...
            return function (t) {
                ...
                function a(t, e, i, n, r, a, o, s) {
                    ...
                    if (e && (u.render = e, u.staticRenderFns = i, u._compiled = !0), n && (u.functional = !0), a && (u._scopeId = "data-v-" + a), o ? (l = function (t) {
                ...
                var o = a({
                    ...
                    return i("transition", {attrs: {name: t.transition}}, [i("div", {
                        ...
                        style: {background: t.backgroundColor, opacity: t.opacity},
                        on: {
                            click: function (e) {
                                return e.preventDefault(), t.cancel(e)
                            }
                        }
                    }), i("div", {staticClass: "vld-icon"}, [t._t("before"), t._t("default", [i(t.loader, {
                        tag: "component",
                ...
                var c = (t, e = {}, i = {}) => ({
                    show(n = e, r = i) {
                        const a = Object.assign({}, e, n, {programmatic: !0}),
                            o = new (t.extend(u))({el: document.createElement("div"), propsData: a}),
                            s = Object.assign({}, i, r);
    ...
    /***/
    "./resources/js/payment_method.js":
    /*!****************************************!*\
      !*** ./resources/js/payment_method.js ***!
      \****************************************/
    /*! no exports provided */
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var vue_loading_overlay_dist_vue_loading_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(vue_loading_overlay_dist_vue_loading_css__WEBPACK_IMPORTED_MODULE_1__);
        // Import stylesheet
        ...
        var stripeForm = new Vue({
            ...
            methods: {
                ...
                submitPaymentMethod: function submitPaymentMethod() {
                    ...
                    if (!this.isLoading) {
                        this.isLoading = true;
                        this.stripe.confirmCardSetup(this.$refs.clientSecret.value, {
                            payment_method: {
                                card: this.card,
                                billing_details: {
                                    name: this.name
                            ...
                            if (result.error) {
                                ...
                                _this.msg = result.setupIntent.status;
                            ...
                            if (setupIntent) {
                                return axios.post('/payment_methods', {
                                    ...
                                    _this.$refs.paymentMethodsUrl.click();
                                });
                            }
    ...
    2:
    /*!**********************************************!*\
      !*** multi ./resources/js/payment_method.js ***!
      \**********************************************/
    /*! no static exports found */
    /***/ (function (module, exports, __webpack_require__) {

        module.exports = __webpack_require__(/*! C:\projects\web\packageDelivery\resources\js\payment_method.js */"./resources/js/payment_method.js");
